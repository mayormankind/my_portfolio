...
function Projects() {
  ...
  const isDark = colorMode==='dark';
    const projectList = [
        ...
        {id:'6',projectName:"Pick n' Toe",projectDetails:'A TIC-TAC-TOE multiplayer that you could play game with your friends. Designed with javascript',projectImage:'/images/pnt1.png',pref:'https://tic-tac-toe-mankind.vercel.app',frameworks:['HTML','JavaScript','CSS/SCSS']},
