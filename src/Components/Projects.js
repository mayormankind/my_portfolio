...
function Projects() {
  ...
  const isDark = colorMode==='dark';
    const projectList = [
        ...
        {id:'8',projectName:`HillTop Snake`,projectDetails:'A snake game',projectImage:'https://res.cloudinary.com/dcesze7l8/image/upload/v1666756727/portfolio/etn_my3i4g.png',pref:'https://eit-website.vercel.app',github:'https://github.com/mayormankind/Hill-top_Snake',frameworks:['react','chakraUI','react-icons']}
    ];
  return (
