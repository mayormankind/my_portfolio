...
function Projects() {
  ...
  const isDark = colorMode==='dark';
    const projectList = [
        ...
        {id:'4',projectName:'Lightgram',projectDetails:'A central web app for a community.',projectImage:'https://res.cloudinary.com/dcesze7l8/image/upload/v1665533485/portfolio/p4_wz6gxs.png',pref:'https://lightgram-app.vercel.app',frameworks:['react','chakraUI','react-icons']},
        {id:'5',projectName:"My Portfolio",projectDetails:'My personal potfolio that consists of projects i have worked on',projectImage:'https://res.cloudinary.com/dcesze7l8/image/upload/v1665533472/portfolio/p5_m8xwvj.png',pref:'https://my-portfolio-delta-lac.vercel.app',frameworks:['react','chakraUI','react-icons']},
  ...
  return (
    <Box bg={isDark?'rgb(15,15,15)':'rgb(150,150,150)'} w='100%' h='100%' id='projects' className='scroll'>
        ...
        <Box as={'ul'} w='100%' h={'100%'} flexWrap='wrap' justify={'space-around'} display={'grid'} gridTemplateColumns={{sm:'repeat(auto-fit, minmax(500px, 1fr))',base:'repeat(auto-fit, minmax(390px, 1fr))'}} p={{sm:'20px',base:'0 10px'}} gridGap='20px'>
