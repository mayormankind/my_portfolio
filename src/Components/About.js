    ...
    // <Box>
      <Stack px={isBigScreen?'0':'20px'} mt={isBigScreen?'0':'10px'} position='relative'>
        <Flex p={isBigScreen ? '40px':'0'} justify={'center'} flexDir={isBigScreen?'row':'column'}>
          ...
          <Image alt='Makinde Mayowa' src='/eku3.png' objectFit={'cover'} boxSize={'250'} boxShadow='lg' alignSelf={'center'} mt={isBigScreen?'0':'10px'} borderRadius='50%' border={isDark?'10px solid silver':'10px solid black'}/>
        </Flex>
      </Stack>
    // </Box>
  )
